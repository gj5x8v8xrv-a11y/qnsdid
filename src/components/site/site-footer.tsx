    ...
    <footer className="mt-16 border-t border-black/8 bg-white text-black lg:mt-24">
      <div className="page-shell grid gap-10 py-14 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <div className="space-y-5">
          <p className="text-[11px] uppercase tracking-[0.34em] text-muted">BUNYANG MAP</p>
        ...
        <div>
          <p className="text-sm font-semibold text-black">사이트맵</p>
        ...
        <div>
          <p className="text-sm font-semibold text-black">문의 안내</p>
          <div className="mt-4 grid gap-3">
