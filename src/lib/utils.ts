...
export function getDefaultHomePageSettings(): HomePageSettings {
  return {
    ...
    mobileHeaderAnnouncementPx: 9,
    mobileHeaderBrandEnglishPx: 9,
    mobileHeaderBrandNameRem: 1.05,
    mobileHeaderBrandCaptionPx: 9,
    mobileHeaderNavPx: 12,
    mobileHeaderButtonPx: 13,
    mobileHeroEyebrowPx: 9,
    mobileHeroTitleRem: 1.42,
    mobileHeroStatLabelPx: 11,
    mobileHeroStatValueRem: 1.45,
    mobileFeaturedLabelPx: 12,
    mobileSectionTitleRem: 1.34,
    mobileBodyTextPx: 13,
    mobileProjectCardTitleRem: 1.08,
    mobileProjectCardMetaPx: 11.2,
    mobileProjectCardBodyPx: 13,
    mobileProjectCardLabelPx: 13,
    mobileProjectCardButtonPx: 12.16,
    mobileCompletedListTitlePx: 14,
    mobileCompletedListBodyPx: 13,
    mobileStickyEyebrowPx: 12,
    mobileStickyTitleRem: 1.5,
    mobileStickyBodyPx: 14,
    mobileStickyButtonPx: 14,
    mobileFooterEyebrowPx: 11,
    mobileFooterTitlePx: 14,
    mobileFooterBodyPx: 14,
    mobileFooterLinkPx: 14,
    mobileFooterBottomPx: 12
  };
}
